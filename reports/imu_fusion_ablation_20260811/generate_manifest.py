...
RAW_DIR = ROOT / "reports" / "raw" / "imu_fusion_ablation_20260811" / "data"
CAPTURES = [
...
def main() -> None:
    ...
    for (capture_id, protocol, motion, complete, source_file,
        ...
        rows.append(
            {
                ...
                "archive_file": f"../raw/imu_fusion_ablation_20260811/data/{archive_name}",
        ...
        sums.append(
            f"{archive_digest}  ../raw/imu_fusion_ablation_20260811/data/{archive_name}"
        )
