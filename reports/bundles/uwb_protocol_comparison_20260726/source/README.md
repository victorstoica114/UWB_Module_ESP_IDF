...
```bash
xz --decompress --keep reports/bundles/uwb_protocol_comparison_20260726/raw/data/*.jsonl.xz
cd ../..
python3 tools/uwb_compare_analyze.py
cd reports/bundles/uwb_protocol_comparison_20260726/source
latexmk -pdf -interaction=nonstopmode -halt-on-error report.tex
```

Primary artifacts:

- [`../../../uwb_protocol_comparison_20260726.pdf`](../../../uwb_protocol_comparison_20260726.pdf): final English report;
...
- `../raw/data/*.jsonl.xz`: complete official captures;
