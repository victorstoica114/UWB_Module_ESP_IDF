...
|---|---|---|---|---|---|---|---|---|---|---|
| flextdoa_dynamic_final_01 | FlexTDOA | dynamic | 240.5 | 4023 | 16.73 | 20.32 | 12.90 | 99.4 | 160.0 | 2550.0 |
| native_ds_dynamic_quality_gate_02 | Native DS-TWR | dynamic | 243.0 | 5069 | 20.86 | 20.91 | 20.86 | 99.7 | 70.0 | 1020.0 |
| passive_ds_dynamic_final_01 | Passive DS-TWR | dynamic | 176.9 | 7033 | 39.75 | 39.70 | 13.33 | 100.0 | 120.0 | 2680.0 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| FlexTDOA | dynamic | 17.24 | 150.0 | 3620.0 | 100.0 | 4 | 0.183 | 0.174 | 0.004 | indicative_in_system_reference |
| Native DS-TWR | dynamic | 20.91 | 70.0 | 1020.0 | 99.9 | 0 | 0.172 | 0.163 | 0.003 | indicative_in_system_reference |
| Passive DS-TWR | dynamic | 13.31 | 250.0 | 2850.0 | 99.8 | 3 | 0.141 | 0.138 | 0.007 | indicative_in_system_reference |
...
|---|---|---|---|---|---|---|---|---|---|
| FlexTDOA | dynamic | 1100 | 65.6 | 0.183 | 0.306 | 0.172 | 0.014 | usable with limits | indicative_in_system_reference |
| Native DS-TWR | dynamic | 1892 | 28.0 | 0.187 | 0.284 | 0.148 | 0.023 | usable with limits | indicative_in_system_reference |
| Passive DS-TWR | dynamic | 1154 | 83.4 | 0.168 | 0.347 | 0.168 | 0.015 | usable with limits | indicative_in_system_reference |
...
- `../raw/data/*.jsonl.xz`: the seven RAW captures used by the report, compressed losslessly;
