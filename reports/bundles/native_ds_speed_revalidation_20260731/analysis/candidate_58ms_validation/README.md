...
- Raw range events: 11433
- Sequence delivery: 93.32%
...
- Reference geometry: Unchanged setup; decisive validation of 14 ms slot plus 2 ms gap (58 ms frame).
...
|---|---:|---:|---:|---:|---:|---:|
| Coherent independent frames | 12.00 | 1.00 | 0.90 | 1.12 | 2.30 | 3.86 |
| Rolling latest ranges | 63.48 | 1.01 | 0.92 | 1.14 | 2.36 | 4.94 |
...
- `data/candidate_58ms_validation_180s.jsonl` — deduplicated DS-TWR range events and status snapshots
- `data/candidate_58ms_validation_180s.logs.jsonl` — raw dashboard log records, including every `UWB_RANGING result` line
- `data/candidate_58ms_validation_180s.metadata.json` — full initial/final module status and capture settings
