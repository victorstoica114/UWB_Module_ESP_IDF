...
- Raw range events: 11467
- Sequence delivery: 87.14%
- Radio: channel 5 · slot 5 ms · round gap 1 ms · RX slice 100 ms
...
- Reference geometry: 60 s static screening, unchanged setup. Native DS-TWR 17 ms timing 4/1/4/1/1 ms, no filtering.
...
|---|---:|---:|---:|---:|---:|---:|
| Coherent independent frames | 39.77 | 0.96 | 0.93 | 1.10 | 2.35 | 3.88 |
| Rolling latest ranges | 191.04 | 1.00 | 0.96 | 1.11 | 2.33 | 16.33 |
...
- `data/profile_17ms_screen_60s.jsonl` — deduplicated DS-TWR range events and status snapshots
- `data/profile_17ms_screen_60s.logs.jsonl` — raw dashboard log records, including every `UWB_RANGING result` line
- `data/profile_17ms_screen_60s.metadata.json` — full initial/final module status and capture settings
