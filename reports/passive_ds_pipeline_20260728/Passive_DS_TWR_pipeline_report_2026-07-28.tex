...
retains the four event streams and metadata consumed by the generator, plus
bootstrap outputs and metrics. Raw dashboard log streams were removed under
the 2026-08-29 aggressive retention policy.
