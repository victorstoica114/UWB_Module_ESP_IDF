    ...
    size_t anchor_count)
{
    ...
    // Figure 2: after receiving REQ, responders wait for the 250 us request
    // processing phase, then answer in ordered 250 us response subslots.
